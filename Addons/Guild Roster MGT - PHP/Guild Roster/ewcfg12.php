<?php
// Make sure to edit lines 50 before you load the page, else in result to an error - KCoder
...
// General - Edit Nothing Here(Youve been warned
...
define("EW_PROJECT_ID", "{035BB177-6A34-4418-A6BD-DF1DD7A296CE}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", 'n8v2lamjQlpoSKNU', TRUE); // Random key for encryption
...
$EW_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "edit host name here", "port" => edit port here, "user" => "edit db username here", "pass" => "edit db password here", "db" => "edit database name here", "qs" => "`", "qe" => "`");
...
define("EW_USER_TABLE", "`nos_roster_admin`", TRUE);
define("EW_USER_NAME_FILTER", "(`admin_name` = '%u')", TRUE);
