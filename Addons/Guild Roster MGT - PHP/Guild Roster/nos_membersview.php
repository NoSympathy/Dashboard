...
$nos_members_view = NULL; // Initialize page object first

class cnos_members_view extends cnos_members {
	...
	// Page object name
	var $PageObjName = 'nos_members_view';
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["memberID"] <> "") {
				...
				$sReturnUrl = "nos_memberslist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "nos_memberslist.php"; // No matching record, return to list
					}
			}
		} else {
			$sReturnUrl = "nos_memberslist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($nos_members_view)) $nos_members_view = new cnos_members_view();

// Page init
$nos_members_view->Page_Init();

// Page main
$nos_members_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$nos_members_view->Page_Render();
?>
...
var CurrentForm = fnos_membersview = new ew_Form("fnos_membersview", "view");

// Form_CustomValidate event
fnos_membersview.Form_CustomValidate = 
...
fnos_membersview.ValidateRequired = true;
<?php } else { ?>
fnos_membersview.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fnos_membersview.Lists["x_profession[]"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fnos_membersview.Lists["x_profession[]"].Options = <?php echo json_encode($nos_members->profession->Options()) ?>;
fnos_membersview.Lists["x_game_type[]"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fnos_membersview.Lists["x_game_type[]"].Options = <?php echo json_encode($nos_members->game_type->Options()) ?>;
fnos_membersview.Lists["x_division[]"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fnos_membersview.Lists["x_division[]"].Options = <?php echo json_encode($nos_members->division->Options()) ?>;
fnos_membersview.Lists["x_has_expansion"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fnos_membersview.Lists["x_has_expansion"].Options = <?php echo json_encode($nos_members->has_expansion->Options()) ?>;
...
<?php $nos_members_view->ExportOptions->Render("body") ?>
<?php
	foreach ($nos_members_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php echo $Language->SelectionForm(); ?>
<div class="clearfix"></div>
</div>
<?php $nos_members_view->ShowPageHeader(); ?>
<?php
$nos_members_view->ShowMessage();
?>
<form name="fnos_membersview" id="fnos_membersview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($nos_members_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $nos_members_view->Token ?>">
<?php } ?>
...
<span id="el_nos_members_name" data-page="1">
<span<?php echo $nos_members->name->ViewAttributes() ?>>
<?php echo $nos_members->name->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span id="el_nos_members__email" data-page="1">
<span<?php echo $nos_members->_email->ViewAttributes() ?>>
<?php echo $nos_members->_email->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span id="el_nos_members_profession" data-page="1">
<span<?php echo $nos_members->profession->ViewAttributes() ?>>
<?php echo $nos_members->profession->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span id="el_nos_members_game_type" data-page="1">
<span<?php echo $nos_members->game_type->ViewAttributes() ?>>
<?php echo $nos_members->game_type->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span id="el_nos_members_division" data-page="1">
<span<?php echo $nos_members->division->ViewAttributes() ?>>
<?php echo $nos_members->division->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span id="el_nos_members_has_expansion" data-page="1">
<span<?php echo $nos_members->has_expansion->ViewAttributes() ?>>
<?php echo $nos_members->has_expansion->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($nos_members->notes->Visible) { // notes ?>
	<tr id="r_notes">
		...
		<td data-name="notes"<?php echo $nos_members->notes->CellAttributes() ?>>
<span id="el_nos_members_notes" data-page="1">
<span<?php echo $nos_members->notes->ViewAttributes() ?>>
<?php echo $nos_members->notes->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<script type="text/javascript">
fnos_membersview.Init();
</script>
<?php
$nos_members_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$nos_members_view->Page_Terminate();
?>
